...
const currentType = type8Data.type;

const prevType = currentType === 1 ? 9 : currentType - 1;
const nextType = currentType === 9 ? 1 : currentType + 1;
  
  const theoryRow1 = type8Data.coreModules.slice(0, 4);
  const theoryRow2 = type8Data.coreModules.slice(4, 8);
  ...
  return (
    <div className="rathmer-page type-8-page">
  ...
  <button
    ...
    Typ {nextType} →
      ...
      <header className="rathmer-home-header">
        ...
        <h1>Typ 8 – Der Anführer</h1>

        <p>
          Eine interaktive Übersicht der Typ-8-Struktur, ihrer Grunddynamik und
          Subtypen.
        </p>
      </header>
      ...
      <section className="rathmer-top-grid">
        <div>
          <button
            ...
            style={{
    "--active-glow": TYPE_GLOW_COLORS[type8Data.type],
  }}            onClick={() =>
              toggleItem(
                openTopItems,
                setOpenTopItems,
                "center",
                type8Data.centerInfo
              )
            }
          >
            {type8Data.center}
          ...
          return (
            <div key={module.label}>
              <button
                ...
                style={{
  borderColor: active
    ? TYPE_GLOW_COLORS[type8Data.type]
    : "transparent",
}}
                onClick={() =>
                  toggleItem(
      ...
      <section className="rathmer-main-grid">
        {type8Data.subtypes.map((subtype) => (
...
style={{
  ...
  style={{
    background: selectedSubtypeItem
      ? undefined
      : TYPE_INFO_GRADIENTS[type8Data.type],
  }}
>
          {selectedSubtypeItem ? (
            <>
