...
export default function TypePage({ onBack, onSelectType }) {
  ...
  const currentType = type3Data.type;
      ...
      <section className="rathmer-top-grid">
        <div>
          <button
            ...
            }`}style={{"--active-glow": TYPE_GLOW_COLORS[type3Data.type],            onClick={() =>
              toggleItem(
                openTopItems,
                setOpenTopItems,
                "center",
        ...
        <div>
          <button
            ...
            style={{"--active-glow": TYPE_GLOW_COLORS[type3Data.type],
  }}            onClick={() =>
              toggleItem(
                openTopItems,
                setOpenTopItems,
          ...
          return (
            <div key={module.label}>
              <button
                ...
                style={{
    "--active-glow": TYPE_GLOW_COLORS[type3Data.type],
  }}                onClick={() =>
                  toggleItem(
                    openTheoryRow1Items,
          ...
          return (
            <div key={module.label}>
              <button
                ...
                style={{
  borderColor: active
    ? TYPE_GLOW_COLORS[type3Data.type]
    : "transparent",
}}
                onClick={() =>
                  toggleItem(
...
style={{
  background: TYPE_GRADIENTS[type3Data.type],
}}
              onClick={() => {
  ...
  style={{
    background: selectedSubtypeItem
      ? undefined
      : TYPE_INFO_GRADIENTS[type3Data.type],
  }}
>
          {selectedSubtypeItem ? (
            <>
