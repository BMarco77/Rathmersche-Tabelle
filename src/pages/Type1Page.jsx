...
export default function TypePage({ onBack, onSelectType }) {
  ...
  <button
    ...
    {nextType} Typ →
      ...
      <header className="rathmer-home-header">
        ...
        <h1>Typ 1 – Der Perfektionist</h1>

        <p>
          Eine interaktive Übersicht der Typ-1-Struktur, ihrer Grunddynamik und
          Subtypen.
        </p>
      </header>
          ...
          return (
            <div key={module.label}>
              <button
               ...
               style={{
  borderColor: active
    ? TYPE_SHADOWS[type1Data.type]
    : `${TYPE_SHADOWS[type1Data.type]}55`,
}}
                onClick={() =>
                  toggleItem(
                    openTheoryRow1Items,
  ...
  style={{
    background: selectedSubtypeItem
      ? undefined
      : TYPE_INFO_GRADIENTS[type1Data.type],
  }}
>
          {selectedSubtypeItem ? (
            <>
