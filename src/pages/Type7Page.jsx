...
const currentType = type7Data.type;

const prevType = currentType === 1 ? 9 : currentType - 1;
const nextType = currentType === 9 ? 1 : currentType + 1;
  
  const theoryRow1 = type7Data.coreModules.slice(0, 4);
  const theoryRow2 = type7Data.coreModules.slice(4, 8);
  ...
  <button
    ...
    Typ {nextType} →
      ...
      <header className="rathmer-home-header">
        ...
        <h1>Typ 7 – Der Optimist</h1>

        <p>
          Eine interaktive Übersicht der Typ-7-Struktur, ihrer Grunddynamik und
          Subtypen.
        </p>
      </header>
          ...
          return (
            <div key={module.label}>
              <button
                ...
                style={{
  borderColor: active
    ? TYPE_SHADOWS[type7Data.type]
    : `${TYPE_SHADOWS[type7Data.type]}55`,
}}
                onClick={() =>
                  toggleItem(
                    openTheoryRow2Items,
      ...
      <section className="rathmer-main-grid">
        {type7Data.subtypes.map((subtype) => (
          <div key={subtype.code} className="rathmer-subtype-column">
            <button
             ...
             style={{
  background: TYPE_GRADIENTS[type7Data.type],
  boxShadow: `0 16px 30px ${TYPE_SHADOWS[type7Data.type]}`,
}}
              onClick={() => {
